...
class DeleteOutlineView(APIView):
    def delete(self, request, pk):
        selectedOutline = outline.objects.get(id=pk)
        selectedOutline.delete()
        return Response('Outline succesfully deleted!')
...
class DeleteLearningOutcomeView(APIView):
    def delete(self, request, pk):
        selectedLearningOutline = learningOutcomes.objects.get(id=pk)
        selectedLearningOutline.delete()
        return Response('Learning outcome succesfully deleted!')